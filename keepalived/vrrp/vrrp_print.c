...
vrrp_print_json(void)
{
	...
	for (e = LIST_HEAD(l); e; ELEMENT_NEXT(e)) {
		...
		json_object_object_add(json_data, "strict_mode",
			json_object_new_int(vrrp->strict_mode));
		json_object_object_add(json_data, "vmac_flags",
			json_object_new_int(vrrp->vmac_flags));
		...
		json_object_object_add(json_data, "garp_delay",
			json_object_new_int(vrrp->garp_delay));
		json_object_object_add(json_data, "garp_refresh",
			json_object_new_int(vrrp->garp_refresh.tv_sec));
		json_object_object_add(json_data, "garp_refresh_timer",
			json_object_new_int(vrrp->garp_refresh_timer.tv_sec));
		json_object_object_add(json_data, "garp_rep",
			json_object_new_int(vrrp->garp_rep));
		json_object_object_add(json_data, "garp_refresh_rep",
			json_object_new_int(vrrp->garp_refresh_rep));
		json_object_object_add(json_data, "garp_lower_prio_delay",
			json_object_new_int(vrrp->garp_lower_prio_delay));
		json_object_object_add(json_data, "garp_pending",
			json_object_new_boolean(vrrp->garp_pending));
		json_object_object_add(json_data, "gna_pending",
			json_object_new_boolean(vrrp->gna_pending));
		json_object_object_add(json_data, "garp_lower_prio_rep",
			json_object_new_int(vrrp->garp_lower_prio_rep));
		json_object_object_add(json_data, "lower_prio_no_advert",
			json_object_new_int(vrrp->lower_prio_no_advert));
		json_object_object_add(json_data, "higher_prio_send_advert",
			json_object_new_int(vrrp->higher_prio_send_advert));
		...
		for (f = LIST_HEAD(v); f; ELEMENT_NEXT(f)) {
		...
		json_object_object_add(json_data, "evip_add_ipv6",
			json_object_new_boolean(vrrp->evip_add_ipv6));
		json_object_object_add(json_data, "master_adver_int",
			json_object_new_int(vrrp->master_adver_int));
		json_object_object_add(json_data, "accept",
			json_object_new_int(vrrp->accept));
		json_object_object_add(json_data, "iptable_rules_set",
			json_object_new_boolean(vrrp->iptable_rules_set));
		...
		json_object_object_add(json_data, "preempt_delay",
			json_object_new_int(vrrp->preempt_delay));
		json_object_object_add(json_data, "preempt_time",
			json_object_new_int(vrrp->preempt_time.tv_sec));
		...
		json_object_object_add(json_data, "fd_in",
			json_object_new_int(vrrp->fd_in));
		json_object_object_add(json_data, "fd_out",
			json_object_new_int(vrrp->fd_out));
		json_object_object_add(json_data, "debug",
			json_object_new_int(vrrp->debug));
		json_object_object_add(json_data, "quick_sync",
			json_object_new_int(vrrp->quick_sync));
		...
		json_object_object_add(json_data, "notify_exec",
			json_object_new_boolean(vrrp->notify_exec));
		json_object_object_add(json_data, "ms_down_timer",
			json_object_new_int(vrrp->ms_down_timer));
		json_object_object_add(json_data, "sands",
			json_object_new_int(vrrp->sands.tv_sec));
		json_object_object_add(json_data, "auth_type",
			json_object_new_int(vrrp->auth_type));
		json_object_object_add(json_data, "ip_id",
			json_object_new_int(vrrp->ip_id));
