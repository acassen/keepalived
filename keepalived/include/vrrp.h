...
extern bool vrrp_state_fault_rx(vrrp_t *, const vrrphdr_t *, char *, ssize_t);
#endif
extern bool vrrp_state_master_rx(vrrp_t *, const vrrphdr_t *, char *, ssize_t);
extern void vrrp_state_master_tx(vrrp_t *);
extern void vrrp_state_backup(vrrp_t *, const vrrphdr_t *, char *, ssize_t);
