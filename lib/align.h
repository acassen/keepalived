 ...
 *    keepalived to check that there are no unaligned casts. 19 such instances of
 *    unaligned char array pointers being cast to structure pointers with greater
 *    alignment when this check was first added.
 *
